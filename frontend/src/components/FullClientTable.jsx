// ======================================================
// src/components/FullClientTable.jsx (FINAL)
// Matches final app.py + AddClient + EditClient
// ======================================================
        ...
        <tbody>
          {clients.map((r) => (
            <tr key={r.id}>
              ...
              <td>{Array.isArray(r.listOfLanguage) ? r.listOfLanguage.join(", ") : r.listOfLanguage}</td>
              ...
              <td>
                <Link to={`/edit-client/${r.id}`} className="btn hollow">
                  Edit
                </Link>
              </td>
            </tr>
