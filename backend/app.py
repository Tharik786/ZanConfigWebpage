...
def get_client_defaults():
    ...
    try:
        ...
        client_appdetails_defaults = {
            ...
            "listOfLanguage": DEFAULT_LANG_LIST,          # ["English", ...]
            ...
            # extra field you had in defaults even if not in form
        }
        ...
        notification_config_defaults = {
            ...
            # thresholds & timing – you marked as VARCHAR in comment,
            # but empty defaults are safe to start with:
